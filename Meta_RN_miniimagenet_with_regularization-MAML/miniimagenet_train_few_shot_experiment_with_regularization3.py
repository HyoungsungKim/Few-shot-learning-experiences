    ...
    for episode in range(EPISODE):
        ...
        for meta_batch in range(META_BATCH_SIZE):
            ...
            for inner_batch in range(INNER_BATCH_SIZE):
                ...
                #inner_relation_gradients = inner_loss.backward()
                #print(inner_relation_gradients)
                #print(inner_relation_gradients2)
                #assert 1 == 2
                '''
            ...
            outer_step_size = LEARNING_RATE * (1 - meta_batch / META_BATCH_SIZE)
            relation_network.weight = (relation_fast_weights - relation_network.weight) * outer_step_size
