...
def main():    
    ...
    for episode in range(EPISODE):
        ...
        for meta_batch in range(META_BATCH_SIZE):
            ...
            relation_network.weight = relation_weights_before            
            ...
            #relation_gradients = torch.autograd.grad(loss, relation_network.weight, create_graph=True, allow_unused=True)
            #relation_name_grads = {name: g for ((name, _), g) in zip(relation_network.weight, relation_gradients)}
