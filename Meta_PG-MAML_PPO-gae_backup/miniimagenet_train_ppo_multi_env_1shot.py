...
import os
import models
import ppoAgent_gae as ppoAgent
...
def main():    
    ...
    agent = ppoAgent.PPOAgent(actor, critic, GAMMA, ENTROPY_WEIGHT, CLASS_NUM, device)
    ...
    for episode in range(EPISODE):
        ...
        for meta_batch in range(META_BATCH_RANGE):
            ...
            agent.train(meta_env, policy_loss_list=policy_losses, value_loss_list=value_losses, clip_param=clip_param)
